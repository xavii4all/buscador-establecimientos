...
function dibujarDetalleEstablecimientoHTML(datos_establecimiento, callback){
    ...
    var html_resultados = '<div class="row final mb-2" style="display: block;"> <hr>' +
        ...
        '<button class="btn btn-xl btn-primary btn btn-default form-submit nueva_busqueda" name="op" value="Realizar nueva búsqueda" type="button" data-loading-text="<i class=\'fa fa-circle-o-notch fa-spin\'></i> Processing Order">Realizar nueva búsqueda</button>' +
        '</div>' +
        '</div>';

    // html_resultados += '<canvas id="pdf_area" width="1360" height="400">';
    html_resultados += '<div class="area_impresion" id="pdf_area">';
    ...
    if( imagenes.length > 0 ){
        html_resultados += '<div class="row mt-1 mb-2 imagenes_escuela">';
...
// <!--FILA MAPA-->
    html_resultados +=  '<div class="row row-mbot-2"> ' +
        ...
        '<a href="www.'+datos_establecimiento.establecimiento_web+'">'+datos_establecimiento.establecimiento_web+'</a>'+
        '</div>'+
        '</div>'+
        ...
        '<div class="row row-mbot-1">'+
            '<div class="col-md-12">'+
            '<h5>Web</h5>'+
            '<a href="www.'+datos_establecimiento.dependencia_funcional_web+'" target="_blank">'+datos_establecimiento.dependencia_funcional_web+'</a>'+
            '</div>'+
        '</div>';
